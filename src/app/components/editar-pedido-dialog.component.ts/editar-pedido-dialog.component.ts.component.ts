...
export class EditarPedidoDialogComponent implements OnInit {
  ...
  initializeForm(): void {
    this.form = this.fb.group({
      ...
      provincia: [this.data.tipoRetiro == "tienda" ? "" : this.data.provincia],
      canton: [this.data.tipoRetiro == "tienda" ? "" : this.data.canton],
      distrito: [this.data.tipoRetiro == "tienda" ? "" : this.data.distrito],
      direccionExacta: [this.data.tipoRetiro == "tienda" ? "" : this.data.direccionExacta],
